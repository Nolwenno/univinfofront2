...
export function ContactUpdate() {
    ...
    const doSearch = async () => {
        try {
            setContactData({});
            const adresse = "https://maheut.alwaysdata.net/api/contact/details/" + params.contactId;
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch (`https://maheut.alwaysdata.net/api/contact/update/`+ params.contactId, {
                method: 'PATCH',
                headers: {
    ...
    const doDelete = async () => {
        try {
            await fetch(`https://maheut.alwaysdata.net/api/contact/delete/` + params.contactId, {method:'DELETE'});
