...
export function UserUpdate() {
    ...
    const doSearchForGroup = async () => {
        try {
            setGroupeData([]);
            const address = "https://maheut.alwaysdata.net/api/group/"
    ...
    const doSearchForUser = async () => {
        try {
            setuserData([]);
            const address = "https://maheut.alwaysdata.net/api/user/" + params.userid
            const response = await fetch(address);
            const data = await response.json();
            setuserData(data);
            console.log(data);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch("https://maheut.alwaysdata.net/api/user/update/" + params.userid, {
                method: 'PATCH',
                headers: {
